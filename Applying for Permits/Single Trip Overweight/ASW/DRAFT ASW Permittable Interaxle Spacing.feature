@orv2- https://moti-imb.atlassian.net/browse/ORV2-eature: As a user I need the system to validate legal interaxle spacing so that STOW applications comply with Appendix A Table II and spacing exceptions.
  ...
  Scenario Outline: wheeler spacing below 7.0 m shows required minimum distance
    Given a user has selected vehicle sub-type <vehicleSubType>
     ...
     Then the interaxle spacing is invalid
      And they see "Interaxle spacing for axle unit x and y must be at least 7.0 m."
