...
Feature: As staff I want to apply for a Single Trip Overweight Oversize Empty permit with a length over 27.5m so that I can move my vehicle given the length beyond 27.5m triggers a legal "overload" condition regardless of whether a commodity is being carried.
