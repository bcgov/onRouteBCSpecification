...
Rule: staff must enter a valid WS number to create a credit account
  ...
  Scenario Outline: eGARMS error
    ...
    Examples:
      ...
      | eGARMS return code E0004(colon) Credit Account has Exceeded Negative Allowed Amount. |
...
@orv2-1868-7
Rule: show the eGARMS returned credit limit on credit account details page

@orv2-1868-8
Rule: show the eGARMS returned current balance on credit account details page

@orv2-1868-9
Rule: show the onRouteBC calculated available credit
