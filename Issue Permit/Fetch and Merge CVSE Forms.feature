...
Rule: CVSE forms chosen in the permit application are fetched from the source of truth and merged with the generated permit document

@orv2-1205-1
  Scenario: Optional CVSE forms
    Given the CV Cient has received the issued permit
